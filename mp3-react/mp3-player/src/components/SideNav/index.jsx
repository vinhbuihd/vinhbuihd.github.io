  ...
  return (
    <div className={`sideNav ${showNav ? " " : "tablet"}`}>
      ...
      <div className="navigation">
        <NavLink to="/mymusic" className="navigation-item">
        ...
        <NavLink to="/zingchart" className="navigation-item">
          <div className="navigation-item-icon">
            <FaChartLine />
          </div>
          <div className="navigation-item-title">#zing chart</div>
        </NavLink>
        <NavLink to="/radio" className="navigation-item">
          <div className="navigation-item-icon">
            <GiMusicSpell />
          </div>
          <div className="navigation-item-title">Radio</div>
        </NavLink>
        <NavLink to="/follow" className="navigation-item">
          <div className="navigation-item-icon">
            <BiNews />
          </div>
        ...
        <NavLink to="/newmusic" className="navigation-item">
          <div className="navigation-item-icon">
            <FiMusic />
          </div>
          <div className="navigation-item-title">Nhạc mới</div>
        </NavLink>
        <NavLink to="/category" className="navigation-item">
          <div className="navigation-item-icon">
            <BiNews />
          </div>
          <div className="navigation-item-title">Thể loại</div>
        </NavLink>
        <NavLink to="/topmusic" className="navigation-item">
          <div className="navigation-item-icon">
            <BiCategoryAlt />
          </div>
          <div className="navigation-item-title">Top 100</div>
        </NavLink>
        <NavLink to="/mv" className="navigation-item">
          <div className="navigation-item-icon">
            <MdOndemandVideo />
          </div>
